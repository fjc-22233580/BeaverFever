/**
 * The TileFactory class is responsible for creating different types of tiles based on the given parameters.
 */
public class TileFactory {

    /**
     * Creates a new tile based on the given actor type,
     * also passes in the tile image path so we can pull the correct image from the asset pack.
     *
